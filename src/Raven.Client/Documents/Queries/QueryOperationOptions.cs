...
namespace Raven.Client.Documents.Queries
{
    ...
    public sealed class QueryOperationOptions
    {
        ...
        /// When <see cref="IndexBatchOptions.WaitForIndexes"/> is true, the operation will wait until the affected indexes become non-stale. 
        /// The <see cref="IndexBatchOptions.WaitForIndexesTimeout"/> specifies the maximum duration to wait, and if this period is exceeded while 
        /// <see cref="IndexBatchOptions.ThrowOnTimeoutInWaitForIndexes"/> is true, an exception will be thrown. 
        /// If <see cref="IndexBatchOptions.WaitForSpecificIndexes"/> contains one or more index names, the operation will restrict the wait to those indexes only; otherwise, all relevant indexes are considered.
        /// </summary>
