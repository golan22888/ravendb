...
public class GenAiBasics(ITestOutputHelper output) : RavenTestBase(output)
{
    ...
    [RavenGenAiData(IntegrationType = RavenAiIntegration.vLLM | RavenAiIntegration.Anthropic, DatabaseMode = RavenDatabaseMode.Single)]
...
"
    ...
    [RavenTheory(RavenTestCategory.Ai)]
    [RavenGenAiData(IntegrationType = RavenAiIntegration.vLLM | RavenAiIntegration.Anthropic, DatabaseMode = RavenDatabaseMode.Single, Skip = "need to fix")]
...
if($output.Blocked)
{
    ...
    [RavenTheory(RavenTestCategory.Ai)]
    [RavenGenAiData(IntegrationType = RavenAiIntegration.OpenAi | RavenAiIntegration.vLLM | RavenAiIntegration.Anthropic, DatabaseMode = RavenDatabaseMode.Single)]
